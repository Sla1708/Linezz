...
@MainActor private let logomarkMaterial: PhysicallyBasedMaterial = {
    ...
    frontMaterial.baseColor = .init(tint: #colorLiteral(red: 0.00175051298, green: 0.1953764558, blue: 0.315515101, alpha: 1))
    frontMaterial.emissiveColor = .init(color: #colorLiteral(red: 0.1019607857, green: 0.2784313858, blue: 0.400000006, alpha: 1))
...
@MainActor private let borderMaterial: PhysicallyBasedMaterial = {
    ...
    borderMaterial.baseColor = .init(tint: #colorLiteral(red: 0.001817785669, green: 0.195366025, blue: 0.3196659684, alpha: 1))
...
@MainActor private func makeTextEntity() async throws -> ModelEntity {
    ...
    var textString = AttributedString("Welcome to")
